...
Зачем фотографировать презентацию, \\
		...
		\qrcode[height=4.5cm]{http://bit.ly/TYM_pres}
\end{center}
}
...
\begin{itemize}
	...
	\item выходит только если никто не заметил \linebreak \textbf{серьёзную ошибку};\vspace{2mm}
	\item должен хорошо знать решение Докладчика  и теорию;\vspace{2mm}
	\item в случае выхода отвечает на вопросы жюри;\vspace{2mm}
	\item может получить отрицательные баллы \linebreak за неуместное выступление.
\end{itemize}
}
...
\begin{center}
	...
	\qrcode[height=4.5cm]{https://forms.gle/WuuC2qttGcfETTUm8} \vspace{0.2cm}
...
\Large
\begin{center}
	\qrcode[height=4.5cm]{http://bit.ly/lecture_sqrt2} \vspace{0.3cm}
